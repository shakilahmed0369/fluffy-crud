                                ...
                                <form action="{{ route('admin.currency.update', $currency->id) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <input class="form-control" type="text" name="country_code" value="{{ $currency->country_code  }}">
                                        </div>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <input class="form-control" type="text" name="currency_icon" value="{{ $currency->currency_icon }}">
                                        </div>

                                        <div class="form-group col-12">
                                            <label>{{ __('Currency Rate') }} <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" name="currency_rate" value="{{ $currency->currency_rate }}">
                                        </div>

                                        <div class="form-group col-12">
                                            <label>{{ __('Default') }} <span class="text-danger">*</span></label>
                                            <select name="is_default" class="form-control">
                                                <option value="no" {{ $currency->is_default == 'no' ? 'selected':'' }}>{{ __('No') }}</option>
                                                <option value="yes" {{ $currency->is_default == 'yes' ? 'selected':'' }}>{{ __('Yes') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select name="currency_position" class="form-control">
                                                <option {{ $currency->currency_position == 'before_price' ? 'selected':'' }} value="before_price">{{ __('Before Price') }}</option>
                                                <option {{ $currency->currency_position == 'before_price_with_space' ? 'selected':'' }} value="before_price_with_space">{{ __('Before Price With Space') }}</option>
                                                <option {{ $currency->currency_position == 'after_price' ? 'selected':'' }} value="after_price">{{ __('After Price') }}</option>
                                                <option {{ $currency->currency_position == 'after_price_with_space' ? 'selected':'' }} value="after_price_with_space">{{ __('After Price With Space') }}</option>
                                            </select>
                                        </div>
