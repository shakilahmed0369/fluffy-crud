        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('Edit HelloWorld') }}</div>
                </div>
            </div>
                ...
                <div class="mt-4 row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.hello-world.update', $data->id) }}" method="post" enctype="multipart/form-data" >
                                    @csrf
                                    @method("PUT")
                                    <div class="row">
                                        <div class="col-12">
