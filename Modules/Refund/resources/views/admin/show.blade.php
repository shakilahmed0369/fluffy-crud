...
@section('admin-content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                @if ($refund_request->status == 'pending')
                                    <a href="javascript:;" data-toggle="modal" data-target="#rejectRefund" class="btn btn-danger">{{ __('Make refund rejected') }}</a>
                                @endif

                                @if ($refund_request->status == 'rejected' || $refund_request->status == 'pending')
                                    <a href="javascript:;" data-toggle="modal" data-target="#approveRefund" class="btn btn-success">{{ __('Make approved refund') }}</a>
                                @endif
                    ...
                    <div class="container-fluid">
                        <form action="{{ route('admin.approved-refund-request', $refund_request->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="">{{ __('Refund Amount') }} <span data-toggle="tooltip" data-placement="top" class="fa fa-info-circle text--primary" title="Amount should be USD($)"></label>
    ...
    <div class="modal fade" id="rejectRefund" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    <div class="modal-header">
