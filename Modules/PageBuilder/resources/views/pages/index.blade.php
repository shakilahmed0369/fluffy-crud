                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input onchange="changeStatus({{ $page->id }})" id="status_toggle"
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-toggle="modal" data-target="#deleteModal"
                                                    ...
                                                    onclick="deleteData({{ $page->id }})"><i class="fa fa-trash"
                                                        aria-hidden="true"></i></a>
                                        </tr>
                                        @empty
                                        <x-empty-table :name="__('Customizeable Page')" route="admin.custom-pages.index" create="no"
