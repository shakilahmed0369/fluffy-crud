...
<a href="{{ route('subscription.pay-via-paypal', $plan->id) }}" class="btn btn-primary">
    Pay with paypal
  </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  action="{{route('subscription.pay-via-stripe', $plan->id)}}" method="post">
                        @csrf
                        <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form  action="{{route('subscription.pay-via-bank', $plan->id)}}" method="post">
                        @csrf
