    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ __('admin.FAQs') }}</div>
            </div>
        </div>
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="{{ route('admin.faq.create') }}" class="btn btn-primary"><i
                                        class="fa fa-plus"></i> {{ __('admin.Add New') }}</a>
                                @endadminCan
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input onchange="changeStatus({{ $faq->id }})"
                                                    id="status_toggle" type="checkbox" {{ $faq->status ?
                                                'checked' : '' }}
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:;" data-toggle="modal" data-target="#deleteModal"
                                                    ...
                                                    onclick="deleteData({{ $faq->id }})"><i class="fa fa-trash"
                                                        aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        @empty
                                        <x-empty-table :name="__('admin.Faq')" route="admin.faq.create"
                                            create="yes" :message="__('admin.No data found!')" colspan="5">
                                        </x-empty-table>
                                        @endforelse
                                    </tbody>
                                </table>
