        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">{{ __('admin.Edit Faq') }} ({{ request('code') }})</div>
                </div>
            </div>
                ...
                <div class="mt-4 row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form
                                    action="{{ route('admin.faq.update', ['faq' => $faq->id, 'code' => $code]) }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 offset-md-2">
                                            <div class="form-group">
                                                <label for="answer">{{ __('admin.Answer') }}<span
                                                        class="text-danger">*</span></label>
                                                <textarea data-translate="true" type="text" id="answer" name="answer" placeholder="Enter answer" cols="30" rows="30"
                                                    class="form-control text-area-5">{{ old('answer', $faq->getTranslation($code)->answer) }}</textarea>
                                                @error('answer')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
