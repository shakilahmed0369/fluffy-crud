                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form action="{{ route('admin.admin.update', $admin->id) }}" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-12">
                                                    <label title="Leave it blank if you don't want to change password">{{ __('Password') }} <span class="text-success">*</span></label>
                                                ...
                                                <div class="form-group col-12">
                                                    ...
                                                    <select name="status" class="form-control">
                                                        ...
                                                        <option value="inactive" @selected($admin->status == 'inactive')>{{ __('Inactive') }}</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-12">
                                                    ...
                                                    <select name="role[]" id="role"
                                                        ...
                                                        @foreach ($roles as $role)
                                                            <option value="{{ $role->name }}" @selected($admin->hasRole($role->name))>{{ $role->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
